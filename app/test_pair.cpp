...
int main(int argc, char** argv) {
    ...
    std::string calib_path = "configs/camera_params_reach.yaml";
    std::string img_path_l = "images/left.jpg";
    std::string img_path_r = "images/right.jpg";
    ...
    if (args_map.find("test_image_l")!=args_map.end()) img_path_l = args_map["test_image_l"];
    if (args_map.find("test_image_r")!=args_map.end()) img_path_r = args_map["test_image_r"];
    ...
    left = cv::imread(img_path_l);
    right = cv::imread(img_path_r);
    cv::hconcat(left.clone(), right.clone(), img);
